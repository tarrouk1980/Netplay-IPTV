...
const FLIGHT_TIMES = [
  ...
  { route: 'Bruxelles → Casablanca', time: '3h45', icon: '🇲🇦' },
]

export default function HomePageBE() {
  ...
  return (
    <div style={{ background: '#F8F9FA' }}>
      <GDPRBanner />
      <title>EasyHotels Belgique — Comparez les hôtels au Maroc, Algérie et Tunisie</title>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 900, width: '100%' }}>
          <div style={{
            ...
            ✈ Comparez 500+ hôtels — Les meilleurs prix garantis au Maghreb
          </div>
      ...
      {/* DIASPORA BANNER - Belgium specific */}
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 20 }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 28 }}>🇲🇦</span>
              <span style={{ fontSize: 28 }}>🇹🇳</span>
              <h2 style={{ fontSize: 20, fontWeight: 800, color: '#fff', marginLeft: 4 }}>La diaspora maghrébine en Belgique</h2>
            </div>
            <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: 16, maxWidth: 540 }}>
              Vous rentrez au bled depuis Bruxelles ? Trouvez le meilleur hôtel et comparez les prix en quelques secondes.
            </p>
          </div>
          <button
      ...
      {/* FLIGHT TIMES - Brussels specific */}
      <section style={{ background: '#fff', padding: '50px 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', fontSize: 26, fontWeight: 800, color: '#2d3748', marginBottom: 8 }}>✈️ Vols depuis Bruxelles</h2>
          <p style={{ textAlign: 'center', color: '#718096', marginBottom: 36 }}>Des destinations proches, à moins de 4h de vol depuis Zaventem</p>
      ...
      <section style={{ background: '#F0F7FF', padding: '60px 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 40, textAlign: 'center' }}>
          {[
            { value: '500+', label: 'Hôtels référencés' },
            { value: '7', label: 'Pays couverts' },
            { value: '5', label: 'Comparateurs de prix' },
            { value: '75 000+', label: 'Voyageurs satisfaits' },
          ].map((s, i) => (
            <div key={i}>
              <div style={{ fontSize: 36, fontWeight: 900, color: '#FF6B35' }}>{s.value}</div>
      ...
      <section style={{ padding: '80px 24px', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <h2 style={{ fontSize: 34, fontWeight: 800, color: '#2d3748', marginBottom: 12 }}>🌍 Destinations populaires</h2>
          <p style={{ color: '#718096', fontSize: 16 }}>Les villes les plus recherchées par la communauté belge</p>
        </div>
      ...
      <section style={{ padding: '80px 24px', background: '#f0f4f8' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontSize: 30, fontWeight: 800, color: '#2d3748', marginBottom: 12 }}>Hôtels qui respectent vos valeurs</h2>
      ...
      <section style={{ background: 'linear-gradient(135deg, #004E89 0%, #1a6eac 100%)', padding: '60px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 30, fontWeight: 800, color: '#fff', marginBottom: 12 }}>Vous êtes hôtelier ?</h2>
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 17, marginBottom: 32 }}>
            Rejoignez <strong>47 partenaires EasyHotels</strong> et augmentez votre visibilité auprès de la diaspora belge
          </p>
