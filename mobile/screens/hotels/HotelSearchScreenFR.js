...
const QUICK_FILTERS = [
  ...
  { key: 'Algerie', label: 'Algérie 🇩🇿' },
  { key: 'Tunisie', label: 'Tunisie 🇹🇳' },
  { key: 'Egypte', label: 'Égypte 🇪🇬' },
  { key: 'Mauritanie', label: 'Mauritanie 🇲🇷' },
];

const DESTINATIONS = [
  { city: 'Marrakech', country: 'Maroc', image: 'https://picsum.photos/400/300?random=60' },
  { city: 'Casablanca', country: 'Maroc', image: 'https://picsum.photos/400/300?random=61' },
  { city: 'Alger', country: 'Algérie', image: 'https://picsum.photos/400/300?random=62' },
  { city: 'Oran', country: 'Algérie', image: 'https://picsum.photos/400/300?random=63' },
  { city: 'Tunis', country: 'Tunisie', image: 'https://picsum.photos/400/300?random=64' },
  { city: 'Le Caire', country: 'Égypte', image: 'https://picsum.photos/400/300?random=65' },
];

export default function HotelSearchScreenFR({ navigation }) {
      ...
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        >
          <View style={styles.heroHeader}>
            <View>
              <Text style={styles.heroTagline}>Comparateur de prix pour la diaspora maghrébine</Text>
          ...
          <View style={styles.searchCard}>
            ...
            {/* Country + Cultural Filter Buttons */}
        ...
        {guestModalVisible && (
          <View style={styles.guestModalOverlay}>
            ...
            <View style={styles.guestModal}>
              <Text style={styles.guestModalTitle}>Voyageurs</Text>
              {[1, 2, 3, 4, 5, 6].map(n => (
                ...
                <TouchableOpacity style={styles.featuredCard} onPress={() => navigation.navigate('HotelDetail', { hotelId: item.id, checkIn, checkOut, guests })}>
                  ...
                  <LinearGradient colors={['transparent', 'rgba(0,0,0,0.75)']} style={styles.featuredOverlay}>
                    ...
                    <View style={styles.featuredPriceRow}>
                      <Text style={styles.featuredPrice}>Dès {item.bestOffer?.discountedPrice} €</Text>
        ...
        {trending.length > 0 && (
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>Destinations tendance 🔥</Text>
              <TouchableOpacity onPress={() => navigation.navigate('HotelResults', { destination: '', checkIn, checkOut, guests })}>
                <Text style={styles.seeAll}>Voir tout</Text>
              </TouchableOpacity>
            </View>
              ...
              renderItem={({ item }) => (
                <TouchableOpacity style={styles.trendCard} onPress={() => navigation.navigate('HotelDetail', { hotelId: item.id, checkIn, checkOut, guests })}>
                  ...
                  <View style={styles.trendContent}>
                    ...
                    <Text style={styles.trendPrice}>Dès {item.bestPrice} €</Text>
                  </View>
                </TouchableOpacity>
              )}
            />
        ...
        >
          <View>
            <Text style={{ color: '#fff', fontWeight: '800', fontSize: 15 }}>💼 Publier votre hôtel</Text>
