module.exports = {
  expo: {
    ...
    plugins: [
      ...
      'expo-location',
      'expo-av',
      ['@rnmapbox/maps', { RNMapboxMapsVersion: '10.16.4', RNMapboxMapsDownloadToken: 'sk.eyJ1IjoiZWFzeXdheXRhcmVrIiwiYSI6ImNtcHhoY2Q5dTA4ejgycnIyZ25oMmU1ZTQifQ.AhHhtw_JNEhjY46ditVsSg' }],
    ],
    extra: {
