    ...
    <ScrollView style={s.container}>
      ...
      <View style={s.section}>
        ...
        <View style={s.actionsRow}>
          ...
          <TouchableOpacity style={s.actionBtn} onPress={() => navigation.navigate("SellerCustomers")}>
            <Text style={s.actionIcon}>👥</Text>
            <Text style={s.actionLabel}>Clients</Text>
          </TouchableOpacity>
          <TouchableOpacity style={s.actionBtn} onPress={() => navigation.navigate("SellerStockAlerts")}>
            <Text style={s.actionIcon}>⚠️</Text>
            <Text style={s.actionLabel}>Stocks</Text>
          </TouchableOpacity>
          <TouchableOpacity style={s.actionBtn} onPress={() => navigation.navigate("SellerReport")}>
            <Text style={s.actionIcon}>📋</Text>
            <Text style={s.actionLabel}>Rapport</Text>
          </TouchableOpacity>
          <TouchableOpacity style={s.actionBtn} onPress={() => navigation.navigate("SellerBroadcast")}>
            <Text style={s.actionIcon}>📣</Text>
