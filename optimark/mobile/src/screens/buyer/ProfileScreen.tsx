  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.menu}>
        ...
        <TouchableOpacity style={s.menuItem} onPress={() => navigation.navigate("MyQuestions")}>
          <Text style={s.menuIcon}>❓</Text>
          <Text style={s.menuLabel}>Mes questions</Text>
          <Text style={s.menuArrow}>›</Text>
        </TouchableOpacity>

        <TouchableOpacity style={s.menuItem} onPress={() => navigation.navigate("MyReturns")}>
          <Text style={s.menuIcon}>↩️</Text>
          <Text style={s.menuLabel}>Mes retours</Text>
          <Text style={s.menuArrow}>›</Text>
        </TouchableOpacity>
