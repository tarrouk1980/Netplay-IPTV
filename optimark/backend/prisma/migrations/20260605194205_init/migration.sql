...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('KONNECT', 'PAYMEE', 'CASH_ON_DELIVERY', 'CARD');
...
-- AddForeignKey
ALTER TABLE "LiveSession" ADD CONSTRAINT "LiveSession_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
