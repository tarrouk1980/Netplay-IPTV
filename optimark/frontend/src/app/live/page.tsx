      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 py-10">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <span className="w-3 h-3 bg-rose-800 rounded-full animate-pulse inline-block"></span>
            <h1 className="text-3xl font-bold text-slate-800">Lives en cours</h1>
          </div>
          <Link href="/vendeur/live" className="bg-rose-800 text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-rose-900 transition text-sm">
            Démarrer un live
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <Link href="/vendeur/live" className="bg-rose-800 text-white font-semibold px-6 py-3 rounded-xl hover:bg-rose-900 transition">
              Démarrer un live
            </Link>
          </div>
        ) : (
