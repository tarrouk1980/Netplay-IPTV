      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-8">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <div>
              <p className="font-bold text-slate-800">Préférences de notifications</p>
              <p className="text-slate-500 text-xs">Choisir les notifications à recevoir</p>
            </div>
          </Link>
          ...
          >
            <span className="text-3xl">❓</span>
            <div>
              <p className="font-bold text-slate-800">Mes questions</p>
              <p className="text-slate-500 text-xs">Questions posées aux vendeurs</p>
            </div>
          </Link>
          ...
          >
            <span className="text-3xl">🕐</span>
            <div>
              <p className="font-bold text-slate-800">Récemment vus</p>
              <p className="text-slate-500 text-xs">Produits consultés récemment</p>
            </div>
          </Link>
